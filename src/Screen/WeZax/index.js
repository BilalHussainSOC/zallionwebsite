...
import bg1 from '../../Image/bgimage.png'
import './index.css'
const WeZax=()=>{
        ...
        <Container  className="wezax_text">
            <Grid container>
                 <Grid item lg={8} md={10} sm={10}  xs={12} className='we_zax_heading'>
                         <h1><b>Welcome to the Future of <srong style={{color:'rgb(221,219,38)'}}>Transactions with Zillion</srong> <br></br> Anchor XO (ZAX)!</b></h1>
